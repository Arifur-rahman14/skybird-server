...
app.get('/', (req, res) => {
    res.send('Welcome to SkyBird Agency Server');
})

const client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true });

client.connect(err => {
    const serviceCollection = client.db("package").collection("services");
    const reviewCollection = client.db("package").collection("reviews");
    const adminsCollection = client.db("package").collection("admins");
    const orderCollection = client.db("package").collection("orders");
